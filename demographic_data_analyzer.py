...
def calculate_demographic_data(print_data=True):
    ...
    df_pivot = df.pivot_table(index = 'native-country', columns = 'salary', aggfunc = 'size', fill_value= 0)
    percentage = round(100 * df_pivot['>50K']/(df_pivot['>50K'] + df_pivot['<=50K']), 1).sort_values(ascending=False)
    
    highest_earning_country = percentage.index[0]
    highest_earning_country_percentage = percentage[0]
